        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validateEmail() && validatePhone() && validateName() && validatePassword()) {
                    ...
                    CreateUserAccount(email, name, points, phone, password, category);
    ...
    private void CreateUserAccount(final String email, final String name, final String points, final String phone, final String password, final String category) {
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(this, task -> {
            if (task.isSuccessful()) {
                final String email1 = eemail.getText().toString();
                final String name1 = ename.getText().toString();
                final String category1 = tvoption.getText().toString();
                final String phone1 = ephone.getText().toString();
                final String password1 = epassword.getText().toString();
                final String points1 = point.getText().toString();
                ...
                user.put("priviledge", category1);
                user.put("points", points1);
                ...
                if (task.getException() instanceof FirebaseAuthWeakPasswordException) {
                    ...
                    Toast.makeText(SignUpActivity.this, "Week password. Please use strong password", Toast.LENGTH_SHORT).show();
                } else {
                    Log.e("error", task.getException().getMessage(), task.getException());
